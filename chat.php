...
<!-- Chat section -->
<style>
        /* Add basic styling for the chat area */
        .chat-area {
            width: 100%;
            max-width: 600px;
            margin: 0 auto;
...
<script>
    let senderEmail = 'your_email@example.com'; // Replace with the logged-in user's email
    let selectedUserEmail = 'receiver_email@example.com'; // Replace with the selected user's email
    ...
    function loadChatHistory() {
        $.ajax({
            ...
            success: function(data) {
                $('#chat-box').html(data);  // Insert the fetched messages into the chat-box
            ...
            if (message.trim() !== '') {
                $.ajax({
                    ...
                    success: function() {
                        ...
                        loadChatHistory(); // Reload chat history to show the new message
                    }
                });
            }
        });

        // Optionally, you can use the Enter key to send the message
