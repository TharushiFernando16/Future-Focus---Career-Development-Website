...
// Fetch business magazines
$magazines_sql = "SELECT title, description, link, image FROM magazines";
$magazines_result = $con->query($magazines_sql);
?>
...
<head>
    ...
    <title>FutureFocus Official Website - Business Magazines</title>
    ...
    <link rel="stylesheet" href="./assets/css/businessmagazines.css">
    <!-- Favicon -->
...
<header id="head" class="secondary">
    <div class="container">
        <h1>Resources - Business Magazines</h1>
        ...
        <div class="col-md-12">
            <section id="portfolio" class="page-section section appear clearfix">
                ...
                <p class="rcontent">
                    ...
                    <br /><br />
                    Discover a wealth of articles, guides, webinars, and more curated by industry experts. Stay updated with the latest trends, strategies, and insights to navigate the ever-evolving landscape of the job market.
                    <br /><br />
                    Take charge of your career growth today. Explore our resources and unlock your full potential!
                    <br /><br />
...
<!-- Business Magazines Section -->
<section id="featured-courses">
    <h2>Business Magazines</h2>
    <div class="b.container">
        <div class="row">
            <?php if ($magazines_result->num_rows > 0): ?>
                <?php while($row = $magazines_result->fetch_assoc()): ?>
                    <div class="column">
                        <div class="effect-1">
                            <div class="effect-img">
                                <img src="<?php echo htmlspecialchars($row['image']); ?>" alt="Magazine Image">
                            </div>
                            <div class="effect-text">
                                <h3><?php echo htmlspecialchars($row['title']); ?></h3>
                                <p><?php echo htmlspecialchars($row['description']); ?></p>
                                <div class="effect-btn">
                                    <a class="btn" href="<?php echo htmlspecialchars($row['link']); ?>"><i class="fa fa-eye"></i> Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
                <p>No business magazines found.</p>
            <?php endif; ?>
        </div>
    </div>
