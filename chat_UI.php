...
$user_email = $isLoggedIn ? $_SESSION['unique_id'] : '';
...
<main id="main" class="main">
    ...
    <div class="wrapper chating">
        <section class="chat-area">
            ...
            ?>
            <a href="chatIndex.php" class="back-icon"><i class="fas fa-arrow-left"></i></a>
            ...
            <form action="#" class="typing-area">
                <input type="text" name="incoming_id" id="incoming_id" value="<?php echo htmlspecialchars($user_id); ?>" hidden>
